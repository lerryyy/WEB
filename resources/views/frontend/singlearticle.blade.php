...
<head>
	...
	<link rel="stylesheet" href="{{asset('assets/files/css/bootstrap.css')}}">
	<link rel="stylesheet" href="{{asset('assets/files/css/animate.css')}}">
	<link rel="stylesheet" href="{{asset('assets/files/css/simple-line-icons.css')}}">
	<link rel="stylesheet" href="{{asset('assets/files/css/font-awesome.min.css')}}">
	<link rel="stylesheet" href="{{asset('assets/files/css/style.css')}}">

	<link rel="stylesheet" href="{{asset('assets/files/rs-plugin/css/settings.css')}}">
	...
	<div class="sidebar-menu-container" id="sidebar-menu-container">
		...
		<div class="sidebar-menu-push">
			...
			<div class="sidebar-menu-inner">
				...
				<section class="page-heading wow fadeIn" data-wow-duration="1.5s" style="background-image: url({{asset('assets/files/images/01-heading.jpg')}}">
					<div class="container">
						<div class="page-name">
							<h1>Single Post</h1>
							...
							<div class="col-md-8">
								<div class="blog-single-item">
									...
									<div class="prev-btn col-md-6 col-sm-6 col-xs-6">
										<a href="{{url('/article')}}"><i class="fa fa-angle-left"></i>Previous</a>
									</div>	
								</div>
